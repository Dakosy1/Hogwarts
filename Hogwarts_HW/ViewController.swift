...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    // Define an array of HarryPotterCharacter structures
    ...
    lazy var namesHogwartsTableView: UITableView = {
    ...
    func setUI(){
        view.addSubview(namesHogwartsTableView)
        namesHogwartsTableView.snp.makeConstraints { make in
